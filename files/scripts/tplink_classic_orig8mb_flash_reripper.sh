...
read -p "вынимаю ART"
## хз # это - если wifi однотактный
dd if=fullflash8.bin of=art.bin bs=64k skip=127
## хз # так - если wdr4300 v1.3 с синими ламочками - у него, походу, арт двойной - два блока по 64k
## хз #dd if=fullflash8.bin of=art.bin bs=64k skip=126
