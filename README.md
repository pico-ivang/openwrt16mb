...
Искаропки на wdr4300/wdr3600 идет чип памяти (внутренняя флешка) w25q64 на 8 мбайт в корпусе sop-8.  
Маловато.
...
На том же, что и rg95112nhd Mikrotik
Оперативной памяти, кстати, столько же.

в терминах openWRT wdr4300 - архитектура ath79 (или какой он там правильно)
...
добавим к размеру раздела firmware еще 8Мб (это 0x800000)  
0x7d0000 + 0x80000 = 0xfd0000

и сдвинем начало раздела art   
